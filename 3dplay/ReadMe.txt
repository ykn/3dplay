========================================================================
    Win32 アプリケーション: 3dplay プロジェクトの概要
========================================================================

この 3dplay アプリケーションは、AppWizard により作成されました。
...
3dplay.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル 3dplay.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル 3dplay.rc 
    にインクルードされます。
